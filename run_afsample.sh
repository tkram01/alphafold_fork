...
#UPDATE the DOWNLOAD_DIR to the location of the databases:
...
python run_alphafold.py $std_flags --model_preset multimer_all --fasta_paths $fasta --output_dir $outfolder/ --nstruct 200 --dropout=True
...
python run_alphafold.py $std_flags --model_preset multimer_all --fasta_paths $fasta --output_dir $outfolder/ AF_models_dropout/ --nstruct 200 --dropout=True --no_templates --suffix no_templates
...
python run_alphafold.py $std_flags --model_preset multimer_v1 --fasta_paths $fasta --output_dir $outfolder/ --nstruct 200 --dropout=True --no_templates --max_recycles 21 --suffix no_templates_r21
...
python run_alphafold.py $std_flags --model_preset multimer_v2 --fasta_paths $fasta --output_dir $outfolder/ --nstruct 200 --dropout=True --no_templates --max_recycles 9 --suffix no_templates_r9


python scores_from_json.py $outfolder/
